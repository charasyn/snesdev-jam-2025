...
def writeAsmFile(path: str, tileBinPath: str, palettePath: str):
    ...
    lines=[
        ...
        '.segment "BANK02"',
        f'.export {symname}_tiles',
        f'.export {symname}_tiles_size',
        f'.export {symname}_palette',
        f'.export {symname}_palette_size',
        f'{symname}_tiles: .incbin "{symname}.tiles.bin"',
        f'{symname}_tiles_end:',
        f'{symname}_tiles_size = {symname}_tiles_end - {symname}_tiles',
        f'{symname}_palette: .incbin "{symname}.pal"',
        f'{symname}_palette_end:',
        f'{symname}_palette_size = {symname}_palette_end - {symname}_palette',
